 ...
 */
public class LemmagenUkrFilterTest extends BaseTokenStreamTestCase {

    private static final String[] ACTUAL_WORDS = new String[]{"відповісти", "є", "займаний", "речі", "підпорядкований", "співаючий"};
    private static final String[] LEMMA_WORDS = new String[]{"відповісти", "бути", "займати", "річ", "підпорядкувати", "співати"};
